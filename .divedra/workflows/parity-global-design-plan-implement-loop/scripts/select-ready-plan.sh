...
const items = [
  ...
  ["P3-REPO-ANALYTICS", "3", "Commit and repository analytics", "repository analytics", "Implement commit and repository analytics.", ["P3-FILE-INTELLIGENCE"], "design-docs/specs/design-repo-analytics.md", "impl-plans/active/repo-analytics.md"],
  ["P4-HTTP-SERVER", "4", "REST server surface", "http server", "Implement the REST server surface.", ["P2-BOOKMARKS", "P3-GROUP-LIFECYCLE", "P3-QUEUE-LIFECYCLE", "P3-FILE-INTELLIGENCE"], "design-docs/specs/design-http-server.md", "impl-plans/active/http-server.md"],
  ["P4-SSE", "4", "Live event streaming", "server event streaming", "Implement live server event streaming.", ["P4-HTTP-SERVER", "P2-ACTIVITY"], "design-docs/specs/design-sse.md", "impl-plans/active/sse.md"],
  ["P4-AUTH", "4", "Token and bearer auth", "server auth", "Implement token and bearer authentication.", ["P4-HTTP-SERVER"], "design-docs/specs/design-auth.md", "impl-plans/active/auth.md"],
  ["P4-DAEMON", "4", "Daemon lifecycle", "daemon mode", "Implement daemon lifecycle support.", ["P4-HTTP-SERVER", "P4-SSE"], "design-docs/specs/design-daemon.md", "impl-plans/active/daemon.md"],
  ...
  ["P5-TOOL-REGISTRY", "5", "Tool and model availability helpers", "tool registry", "Implement tool and model availability helpers.", ["P4-PUBLIC-SDK"], "design-docs/specs/design-tool-registry.md", "impl-plans/active/tool-registry.md"],
];
