...
const items = [
  ...
  ["P3-GROUP-LIFECYCLE", "3", "Advanced group controls", "advanced group lifecycle", "Implement advanced group lifecycle controls.", ["P2-ACTIVITY"], "design-docs/specs/design-group-lifecycle.md", "impl-plans/completed/group-lifecycle.md"],
  ...
  ["P3-FILE-INTELLIGENCE", "3", "File intelligence", "file intelligence", "Implement file intelligence derived from Cursor sessions.", ["P2-SESSION-SEARCH"], "design-docs/specs/design-file-intelligence.md", "impl-plans/completed/file-intelligence.md"],
  ...
  ["P4-HTTP-SERVER", "4", "REST server surface", "http server", "Implement the REST server surface.", ["P2-BOOKMARKS", "P3-GROUP-LIFECYCLE", "P3-QUEUE-LIFECYCLE", "P3-FILE-INTELLIGENCE"], "design-docs/specs/design-http-server-core.md", "impl-plans/completed/http-server-core.md"],
  ...
  ["P4-AUTH", "4", "Token and bearer auth", "server auth", "Implement token and bearer authentication.", ["P4-HTTP-SERVER"], "design-docs/specs/design-token-auth.md", "impl-plans/completed/token-auth.md"],
  ["P4-DAEMON", "4", "Daemon lifecycle", "daemon mode", "Implement daemon lifecycle support.", ["P4-HTTP-SERVER", "P4-SSE"], "design-docs/specs/design-daemon-lifecycle.md", "impl-plans/completed/daemon-lifecycle.md"],
