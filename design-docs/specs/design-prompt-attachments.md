...
```bash
cursor-cli-agent session run --prompt <text> --image <path>...
cursor-cli-agent session resume <id> --prompt <text> --image <path>...
cursor-cli-agent group run <name> --prompt <text> --image <path>...
cursor-cli-agent queue add <name> --prompt <text> --image <path>...
cursor-cli-agent queue run <name> --image <path>...
```
