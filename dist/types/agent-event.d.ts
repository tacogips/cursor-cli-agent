...
export type AgentEvent = {
    ...
    readonly reason?: "attachment_validation_failed" | "attachments_unsupported" | "attachments_capability_unknown";
};
/**
 ...
 */
export declare function sessionIdFromEvent(event: AgentEvent): string | undefined;
